...
function ciniki_artcatalog_settingsUpdate(&$ciniki) {
    ...
    $rc = ciniki_artcatalog_checkAccess($ciniki, $args['tnid'], 'ciniki.artcatalog.settingsUpdate'); 
    if( $rc['stat'] != 'ok' ) { 
        return $rc;
    }   
    ...
    foreach($changelog_fields as $field) {
        if( isset($ciniki['request']['args'][$field]) 
            ...
            $strsql = "INSERT INTO ciniki_artcatalog_settings (tnid, detail_key, detail_value, date_added, last_updated) "
            ...
            ciniki_core_dbAddModuleHistory($ciniki, 'ciniki.artcatalog', 'ciniki_artcatalog_history', $args['tnid'], 
