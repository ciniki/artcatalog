...
function ciniki_artcatalog_imageHistory($ciniki) {
    ...
    return ciniki_core_dbGetModuleHistory($ciniki, 'ciniki.artcatalog', 'ciniki_artcatalog_history', $args['business_id'], 'ciniki_artcatalog_images', $args['artcatalog_image_id'], $args['field']);
}
?>
